...
describe('App', () => {
  ...
  describe('Initial Rendering', () => {
    ...
    it('should display initial distance of 0', () => {
      render(<App />)
      expect(screen.getByText(/Distance: 0/)).toBeTruthy()
    })
  ...
  describe('Game State Management', () => {
    ...
    it('should show game over screen when game is over', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText('Game Over')).not.toBeNull()
      }, { timeout: 1000 })

      expect(screen.getByText(/Final Distance: 42/)).toBeTruthy()
    })
  })
  ...
  describe('Restart Functionality', () => {
    it('should restart game when restart button is clicked', async () => {
      ...
      expect(screen.getByText(/Final Distance: 123/)).toBeTruthy()
  ...
  describe('Responsive Scaling', () => {
    it('should render game area with proper dimensions', () => {
      ...
      expect((gameArea as HTMLElement).style.maxWidth).toBe('100%')
    })
  ...
  describe('Component Integration', () => {
    ...
    it('should render game over screen with all elements', async () => {
      ...
      expect(screen.getByText(/Final Distance: 75/)).toBeTruthy()
      expect(screen.getByText(/Press R to restart/)).toBeTruthy()
